...
export default function Search({name, options, icon = "", placeHolder, value, required = false} : {name : string, options: options[], icon?: string, placeHolder?: string, value?: string, required?: boolean}){
